...
if __name__ == "__main__":
    ...
    if args.split == "train_val_set":
        video_id_csv = f"data/scene3d/benchmark_file_lists/train_val_set.csv"
    elif args.split == "train_val_set" and args.download_only_one_video_sequence:
        video_id_csv = (
            f"data/scene3d/benchmark_file_lists/train_val_set_only_one_video.csv"
        )
    elif args.split == "test_set":
        video_id_csv = f"data/scene3d/benchmark_file_lists/test_set.csv"
    elif args.split == "test_set" and args.download_only_one_video_sequence:
        video_id_csv = (
            f"data/scene3d/benchmark_file_lists/test_set_only_one_video.csv"
        )
